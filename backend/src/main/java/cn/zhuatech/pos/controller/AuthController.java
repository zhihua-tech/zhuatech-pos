...
import cn.zhuatech.pos.dto.AuthDto.*;
import cn.zhuatech.pos.repository.UserRepository;
import cn.zhuatech.pos.security.JwtService;
import cn.zhuatech.pos.service.CurrentUserService;
...
public class AuthController {
    ...
    private final UserRepository users; private final CurrentUserService currentUser;
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    public AuthController(AuthenticationManager authenticationManager, JwtService jwtService,
                          UserRepository users, CurrentUserService currentUser) {
        this.authenticationManager = authenticationManager; this.jwtService = jwtService; this.users = users; this.currentUser = currentUser;
    }
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
